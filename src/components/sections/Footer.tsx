...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative pt-20 pb-0 overflow-hidden">
      {/* Top divider */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-3xl p-8 sm:p-12 lg:p-16 text-center overflow-hidden"
        >
          {/* Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#00ff88]/5 via-[#ffd700]/5 to-[#ff6b35]/5" />
          <div className="absolute inset-0 rounded-3xl border border-white/[0.06]" />
          <div className="absolute inset-0 grid-bg opacity-20" />

          {/* Glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-48 bg-[#00ff88] rounded-full opacity-[0.06] blur-[100px]" />

          <div className="relative z-10">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-4">
              Ready to Build Something{' '}
              <span className="text-gradient-green">Amazing?</span>
            </h2>
      ...
      <div className="relative z-10 border-t border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                      ...
                      <li key={label}>
                        {href.startsWith('#') && href !== '#' ? (
                          <button
                            ...
                            className="text-sm text-gray-500 hover:text-[#00ff88] transition-colors cursor-pointer"
                          >
                            {label}
                          </button>
                        ) : (
          ...
          {/* Social Links */}
          <div className="flex items-center gap-4 mt-10 pt-8 border-t border-white/[0.05]">
            {socialLinks.map((social) => (
              <motion.a
                key={social.label}
                href={social.href}
                aria-label={social.label}
                className="w-10 h-10 rounded-lg glass flex items-center justify-center text-gray-500 hover:text-[#00ff88] hover:border-[#00ff88]/20 transition-all duration-300"
